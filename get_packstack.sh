...
echo ''
echo 'packstack --default-password=onecloud --os-neutron-ml2-tenant-network-types=gre --os-compute-hosts=10.1.64.231,10.1.64.241 --provision-all-in-one-ovs-bridge=y --os-neutron-ml2-tenant-network-types=gre --allinone'
